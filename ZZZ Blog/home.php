    ...
    <div class="post-modal-container" id="modal-post">
        <div class="post-modal">
            ...
            <div class="post-header">
                ...
                <div class="post-exit-button"><img class="post-exit-button-img" onclick="closeModal()" src="ASSETS/IMG/UI/CancelIMG.png"></div>
            </div>
