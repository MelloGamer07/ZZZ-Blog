    ...
    switch ($action) {
        ...
        case 'delete_reported_post': {
            ...
            if ($stmt->execute()) {
                ...
                if ($authorId) {
                    $ns = $conn->prepare("INSERT INTO Notifica (IdDestinatario,IdMittenteLog,Tipo,Messaggio) VALUES (?,?,'post_eliminato','Your post was removed by an administrator.')");
        ...
        case 'delete_comment': {
            ...
            if ($stmt->execute()) {
                ...
                if ($authorId) {
                    $ns = $conn->prepare("INSERT INTO Notifica (IdDestinatario,IdMittenteLog,Tipo,IdArticolo,Messaggio) VALUES (?,?,'commento_eliminato',?,'Your comment was removed by an administrator.')");
